...
function WhoCard({ title, text }: { title: string; text: string }) {
  return (
    <div className="card">
      <div className="font-display font-semibold text-[16px] mb-3" style={{ color: "#F5F5F0" }}>
        {title}
      </div>
    ...
    <>
      ...
      <section className="relative min-h-screen flex items-center justify-center overflow-hidden">
        ...
        <div
          ...
          style={{ background: "radial-gradient(ellipse 70% 70% at 50% 50%, transparent 40%, #0A0A0B 100%)" }}
        />
        <Reveal className="relative z-10 max-w-[900px] mx-auto px-6 text-center" y={30}>
          <div className="badge mb-8">Adaptive Compound Intelligence</div>
          <h1
            className="font-display font-semibold leading-[1.06] mb-8"
            style={{ fontSize: "clamp(44px, 7vw, 88px)", color: "#F5F5F0", letterSpacing: "-0.02em" }}
          >
            Your company&apos;s{" "}
        ...
        <div className="max-w-[820px] mx-auto px-6">
          ...
          <Reveal>
            <h2
              ...
              style={{ fontSize: "clamp(32px, 4.5vw, 52px)", color: "#F5F5F0", letterSpacing: "-0.02em", lineHeight: 1.1 }}
            >
              AI got smarter.
              <br />
          ...
          <Reveal delay={0.15}>
            <div className="space-y-6 text-[17px] leading-[1.85]" style={{ color: "#8A8A8F" }}>
              ...
              <p style={{ color: "#6A6A6F", fontStyle: "italic" }}>
                And underneath it, the same fear:{" "}
                <em className="em-glow-white" style={{ color: "#F5F5F0" }}>Is this thing coming for my job?</em>
              </p>
              <p>
                ...
                do <em className="em-glow-white" style={{ color: "#F5F5F0" }}>tasks.</em> Discrete, isolated,
                one-at-a-time tasks. They don&apos;t know your company. They don&apos;t know your team. They
                don&apos;t know you.
              </p>
              <p>Every session starts from zero. One user, one context, one conversation. Done. Gone.</p>
              <p>
              ...
              <p className="font-display font-semibold text-[22px] pt-4" style={{ color: "#F5F5F0", letterSpacing: "-0.01em" }}>
          ...
          <Reveal delay={0.15}>
            <div className="space-y-6 text-[17px] leading-[1.85]" style={{ color: "#8A8A8F" }}>
              ...
              <p>
                ...
                <em className="em-glow-white" style={{ color: "#F5F5F0" }}>joins your team.</em> It learns each
                person individually — their thinking style, their work, their patterns. Over time it
                compounds everything it learns into something your whole organization can draw from.
              </p>
            </div>
          </Reveal>
          <Reveal delay={0.25}>
        ...
        <div className="max-w-[820px] mx-auto px-6">
          ...
          <Reveal>
            ...
            >
              ...
              <span className="text-amber-animate">It&apos;s here to make you irreplaceable.</span>
            </h2>
          </Reveal>
          <Reveal delay={0.15}>
            <div className="space-y-6 text-[17px] leading-[1.85]" style={{ color: "#8A8A8F" }}>
              ...
              <p>
                ACI works <em className="em-glow-white" style={{ color: "#F5F5F0" }}>with</em> your people — not
                around them, not instead of them. The more your team interacts with ACI, the better it
                understands what each person does that only a human can do. The judgment calls. The
                relationships. The creative leaps. The vision.
              </p>
              <p>
          ...
          <Reveal delay={0.25}>
            <div
              ...
              style={{ background: "#111113", border: "1px solid #1E1E21" }}
            >
              <p className="font-display font-semibold text-[20px] mb-4" style={{ color: "#F5F5F0", letterSpacing: "-0.01em" }}>
      ...
      <section id="pillars" className="py-28">
        <div className="max-w-[1100px] mx-auto px-6">
          ...
          <RevealGroup className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-5" stagger={0.08}>
            {[
              <Pillar key="adapts" label="Adapts" text="Every person on your team thinks differently. ACI knows that. A systems architect gets a different experience than a creative director — not because you configured it, but because it learned. One intelligence, calibrated to every individual." />,
              <Pillar key="compounds" label="Compounds" text="The more people interact with ACI, the smarter it gets for everyone. Knowledge from one person's work surfaces when someone else needs it. Patterns emerge that no single person could see. The whole becomes greater than the sum of its parts — and it keeps growing." />,
              <Pillar key="persists" label="Persists" text="Memory that spans months, not minutes. Organized hierarchically — session context flows up into project knowledge, project knowledge into organizational understanding. ACI remembers everything that matters and forgets nothing important." />,
              <Pillar key="proactive" label="Proactive" text="ACI doesn't wait to be asked. It surfaces what's about to matter. Connects the dots before you think to look. Checks in. Does background work. The difference between a tool you go to and a teammate who's always thinking." />,
              <Pillar key="identity" label="Identity" text="ACI has character. It pushes back when something doesn't add up. It has opinions and defends them. It knows your company's values and works from them. An AI that agrees with everything you say isn't thinking — it's performing. ACI earns trust through competence, not compliance." />,
              <div key="cta" className="pillar-card flex flex-col justify-center items-start" style={{ borderColor: "rgba(245,158,11,0.2)", background: "rgba(245,158,11,0.04)" }}>
                <p className="font-display font-semibold text-[22px] mb-4 leading-snug" style={{ color: "#F59E0B", letterSpacing: "-0.01em" }}>
                  One intelligence.<br />Every individual.<br />Always growing.
                </p>
      ...
      {/* ─── 7. THE ORIGIN ─── */}
      <section id="origin" className="py-28" style={{ background: "#0D0D0F", borderTop: "1px solid #1E1E21", borderBottom: "1px solid #1E1E21" }}>
        <div className="max-w-[820px] mx-auto px-6">
          <SectionDivider />
          <Reveal>
            <h2
            ...
            >
              {[
                ...
                <div key={s.label} className="text-center">
                  <p className="text-[15px]" style={{ color: "#5A5A5F" }}>{s.label}</p>
                  <p className="font-display font-semibold text-[18px] mt-1" style={{ color: "#F59E0B" }}>{s.sub}</p>
                </div>
              ))}
            </div>
          </Reveal>
          <Reveal delay={0.1}>
            <p className="text-center text-[18px] italic" style={{ color: "#F5F5F0", fontFamily: "var(--font-lora), Georgia, serif" }}>
        ...
        <div className="max-w-[1100px] mx-auto px-6">
          ...
          <Reveal>
            <div className="text-center mb-16">
              ...
              <p className="mt-5 max-w-[600px] mx-auto text-[17px] leading-relaxed" style={{ color: "#8A8A8F" }}>
          ...
          <RevealGroup className="grid grid-cols-1 md:grid-cols-3 gap-5" stagger={0.1}>
            {[
              <WhoCard key="agency" title="The Agency" text="One intelligence across every client project — not 12 separate ChatGPT tabs. Context that carries between campaigns, clients, and collaborators." />,
              <WhoCard key="startup" title="The Startup" text="Institutional knowledge lives in people's heads and disappears when they're out. ACI makes it permanent — and compounds it over time." />,
              <WhoCard key="enterprise" title="The Enterprise Team" text="You don't need another tool. You need something that knows you, your team, your history, and your goals — without being configured from scratch every week." />,
            ]}
          </RevealGroup>
          <Reveal delay={0.15}>
            <p className="text-center mt-12 text-[18px] font-display font-semibold" style={{ color: "#F5F5F0", letterSpacing: "-0.01em" }}>
              If you&apos;ve ever thought{" "}
              <em className="em-glow-amber" style={{ color: "#F59E0B" }}>there has to be something smarter than this</em>{" "}
              — there is.
              <br />
